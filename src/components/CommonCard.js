...
const CommonCard = ({restaurant}) => {
    const {cloudinaryImageId, avgRating, cuisines, name, areaName, sla, id,loyaltyDiscoverPresentationInfo, promoted} = restaurant.info
      return(
                <Link  to={'/rest/'+ id}><div className='cursor-pointer w-52 h-auto'>
